...
class ArticulosController extends Controller
{
     ...
     {
      $articulos = Articulos::select('id', 'nombre', 'precio', 'cantidad', 'imagenes', 'url')->with('imagenesarticulos:nombre')->get();
     ...
     public function inventario()
     {
      $articulos = Articulos::select('id', 'nombre', 'precio', 'cantidad', 'imagenes', 'url')->with('imagenesarticulos:nombre')->get();
         ...
         return view('admin.articulos.inventario', compact('articulos')); 
     }
