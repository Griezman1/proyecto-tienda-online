      ...
      <div class="page-content">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin/articulos') }}">Articulos</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{ $articulos->nombre }}</li>
          </ol>
        </nav>
...
<div class="content-box-large">
    ...
    <div class="panel-body">
        ...
        <section class="example mt-4">
            ...
            <br> {{ $articulos->cantidad }}
 
            <br>
            <br>
 
            <strong>Creado:</strong>
            <br> {{ $articulos->created_at }}
 
            <br>
            <br>
 
            <strong>Actualizado:</strong>
            <br> {{ $articulos->updated_at }}
            ...
            <a href="{{ route('admin/articulos') }}" class="btn btn-dark">Volver</a>
