...
<html lang="es">
  ...
  <body> 
      ...
      <div class="container mt-5 mb-5">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <h1 style="font-size: 28px;" class=" text-center">REGISTRAR NUEVO PRODUCTO</h1>
    ...
    <section class="example mt-4">
        ...
        <form method="POST" action="{{ route('admin/articulos/store') }}" role="form" enctype="multipart/form-data">
